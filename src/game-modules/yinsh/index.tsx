...
function YinshStyles() {
  return (
    <style>{`
      ...
      .yinsh-player-row.active strong {
        color: #247391;
      }
      ...
      .yinsh-row-list button.selected {
        border-color: #247391;
        box-shadow: 0 0 0 2px rgba(36, 115, 145, 0.18);
      }
      ...
      .yinsh-action-button:disabled,
      .yinsh-row-list button:disabled {
        cursor: default;
        opacity: 0.48;
      }
