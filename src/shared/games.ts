...
export const games: GameDefinition[] = [
  ...
  },
  {
    ...
    accent: "#b97835",
    summary: "경기장마다 다른 특수지형 위에서 왕알을 지키며 상대 왕알을 판 밖으로 밀어내는 다인전 알까기.",
    components: ["원형 목재판 경기장 4종", "플레이어별 왕알 1개", "일반알 2개", "무작위 스킬 알 3개", "경기장별 특수지형과 장치"],
    setup: ["2~4명이 각자 색을 받음", "경기장 하나와 특수지형/장치 배치가 선택됨", "왕알 1개와 알 5개를 자기 시작 구역에 배치", "스킬 알 3개는 플레이어마다 무작위 부여"],
    turnFlow: ["자기 알 하나를 끌어서 방향과 세기를 정함", "왕알은 무겁고 조금만 움직임", "충돌, 특수지형, 버튼/레버 효과를 모두 처리", "다음 생존 플레이어로 차례 이동"],
    winCondition: "왕알이 판 밖이나 구멍으로 빠지면 탈락하고, 마지막까지 왕알이 남은 플레이어가 승리.",
    implementation: ["Matter.js 충돌 계산", "경기장 4종 랜덤 선택", "왕알 저속/고중량 처리", "무작위 스킬 알 3개", "끈적/미끄럼/범퍼/구멍 특수지형", "압력 버튼/킥 레버 장치", "2~4인 생존 턴 순환"],
    table: {
      kind: "rings",
      primaryMetric: "왕알",
