...
export const games: GameDefinition[] = [
  ...
  },
  {
    ...
    components: ["원형 목재판 경기장 4종", "플레이어별 왕알 1개", "일반알 2개", "무작위 스킬 알 3개", "경기장별 특수지형"],
    setup: ["2~4명이 각자 색을 받음", "경기장 하나와 특수지형 배치가 선택됨", "왕알 1개와 알 5개를 자기 시작 구역에 배치", "스킬 알 3개는 플레이어마다 무작위 부여"],
    ...
    implementation: ["Matter.js 충돌 계산", "경기장 4종 랜덤 선택", "왕알 저속/고중량 처리", "무작위 스킬 알 3개", "끈적/미끄럼/범퍼/구멍 특수지형", "2~4인 생존 턴 순환"],
    table: {
      kind: "rings",
      primaryMetric: "왕알",
